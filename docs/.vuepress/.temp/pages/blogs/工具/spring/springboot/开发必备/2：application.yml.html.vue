<template><div><h2 id="_2-application-yml" tabindex="-1"><a class="header-anchor" href="#_2-application-yml" aria-hidden="true">#</a> 2：application.yml.</h2>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>#服务端口
spring:
  application:
    name: exer
  mvc:
