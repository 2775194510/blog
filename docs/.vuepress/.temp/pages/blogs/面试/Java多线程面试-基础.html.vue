...
<h3 id="execute-vs-submit" tabindex="-1"><a class="header-anchor" href="#execute-vs-submit" aria-hidden="true">#</a> execute() vs submit()</h3>
<ul>
...
<h3 id="shutdown-vsshutdownnow" tabindex="-1"><a class="header-anchor" href="#shutdown-vsshutdownnow" aria-hidden="true">#</a> shutdown()VSshutdownNow()</h3>
<ul>
...
<h2 id="_9-threadlocal是什么-有什么用" tabindex="-1"><a class="header-anchor" href="#_9-threadlocal是什么-有什么用" aria-hidden="true">#</a> 9.ThreadLocal是什么？有什么用？</h2>
...
<h2 id="_10-thread类中的yield方法有什么作用" tabindex="-1"><a class="header-anchor" href="#_10-thread类中的yield方法有什么作用" aria-hidden="true">#</a> 10. Thread类中的yield方法有什么作用？</h2>
<p>Yield方法可以暂停当前正在执行的线程对象，让其它有相同优先级的线程执行。它是一个静态方法而且只保证当前线程放弃CPU占用而不能保证使其它线程一定能占用CPU，执行yield()的线程有可能在进入到暂停状态后马上又被执行。</p>
<h2 id="_11-java中的fork-join框架是什么" tabindex="-1"><a class="header-anchor" href="#_11-java中的fork-join框架是什么" aria-hidden="true">#</a> 11. Java中的fork join框架是什么？</h2>
...
<h2 id="_12-synchronized和reentrantlock-的区别" tabindex="-1"><a class="header-anchor" href="#_12-synchronized和reentrantlock-的区别" aria-hidden="true">#</a> 12. synchronized和ReentrantLock 的区别</h2>
...
<h2 id="_13-谈谈volatile的使用及其原理" tabindex="-1"><a class="header-anchor" href="#_13-谈谈volatile的使用及其原理" aria-hidden="true">#</a> 13. 谈谈volatile的使用及其原理</h2>
...
<h2 id="_14-synchronized-关键字和-volatile-关键字的区别" tabindex="-1"><a class="header-anchor" href="#_14-synchronized-关键字和-volatile-关键字的区别" aria-hidden="true">#</a> 14. synchronized 关键字和 volatile 关键字的区别</h2>
<ul>
