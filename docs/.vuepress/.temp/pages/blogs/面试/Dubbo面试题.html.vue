<template><div><h2 id="_1-dubbo是什么" tabindex="-1"><a class="header-anchor" href="#_1-dubbo是什么" aria-hidden="true">#</a> 1.Dubbo是什么？</h2>
...
<h2 id="_2-dubbo和-spring-cloud-有什么区别" tabindex="-1"><a class="header-anchor" href="#_2-dubbo和-spring-cloud-有什么区别" aria-hidden="true">#</a> 2. Dubbo和 Spring Cloud 有什么区别？</h2>
<p>最大的区别：</p>
<ul>
...
<ul>
<li>
<p>Dubbo主要分为服务注册中心，服务提供者，服务消费者，还有管控中心；</p>
</li>
<li>
<p>相比起Dubbo简单的四个模块，SpringCloud则是一个完整的分布式一站式框架，他有着一样的服务注册中心，服务提供者，服务消费者，管控台，断路器，分布式配置服务，消息总线，以及服务追踪等；</p>
</li>
</ul>
<h2 id="_3-dubbo核心组件有哪些" tabindex="-1"><a class="header-anchor" href="#_3-dubbo核心组件有哪些" aria-hidden="true">#</a> 3. Dubbo核心组件有哪些？</h2>
<p><img src="http://blog-img.coolsen.cn/img/image-20210829190835070.png" alt="image-20210829190835070"></p>
<ul>
...
<h2 id="_4-dubbo都支持什么协议-推荐用哪种" tabindex="-1"><a class="header-anchor" href="#_4-dubbo都支持什么协议-推荐用哪种" aria-hidden="true">#</a> 4. Dubbo都支持什么协议，推荐用哪种？</h2>
<p>1、 Dubbo协议：Dubbo默认使用Dubbo协议。</p>
<ul>
...
<p>5、hessian：集成Hessian服务，基于底层Http通讯，采用Servlet暴露服务，Dubbo内嵌Jetty作为服务器实现,可与Hession服务互操作
通讯效率高于WebService和Java自带的序列化</p>
<ul>
<li>
<p>适用于传输大数据包(可传文件)，提供者比消费者个数多，提供者压力较大</p>
</li>
<li>
<p>缺点是参数及返回值需实现Serializable接口，自定义实现List、Map、Number、Date、Calendar等接口</p>
</li>
</ul>
<p>6、thrift协议：对thrift原生协议的扩展添加了额外的头信息。使用较少，不支持传null值</p>
<p>7、memcache：基于memcached实现的RPC协议</p>
<p>8、redis：基于redis实现的RPC协议</p>
<h2 id="_5-dubbo服务器注册与发现的流程" tabindex="-1"><a class="header-anchor" href="#_5-dubbo服务器注册与发现的流程" aria-hidden="true">#</a> 5. Dubbo服务器注册与发现的流程？</h2>
<ul>
...
<h2 id="_6-dubbo内置了哪几种服务容器" tabindex="-1"><a class="header-anchor" href="#_6-dubbo内置了哪几种服务容器" aria-hidden="true">#</a> 6. Dubbo内置了哪几种服务容器？</h2>
<p>三种服务容器：</p>
<ul>
...
<h2 id="_7-dubbo负载均衡的作用" tabindex="-1"><a class="header-anchor" href="#_7-dubbo负载均衡的作用" aria-hidden="true">#</a> 7. Dubbo负载均衡的作用？</h2>
<p>将负载均衡功能实现在rpc客户端侧，以便能够随时适应外部的环境变化，更好地发挥硬件作用。而且客户端的负载均衡天然地就避免了单点问题。定制化的自有定制化的优势和劣势。</p>
<p>它可以从配置文件中指定，也可以在管理后台进行配置修改。</p>
<p>事实上，它支持 服务端服务/方法级别、客户端服务/方法级别 的负载均衡配置。</p>
<h2 id="_8-dubbo有哪几种负载均衡策略-默认是哪种" tabindex="-1"><a class="header-anchor" href="#_8-dubbo有哪几种负载均衡策略-默认是哪种" aria-hidden="true">#</a> 8. Dubbo有哪几种负载均衡策略，默认是哪种？</h2>
<p>Dubbo提供了4种负载均衡实现：</p>
<ol>
...
<h2 id="_9-dubbo服务之间的调用是阻塞的吗" tabindex="-1"><a class="header-anchor" href="#_9-dubbo服务之间的调用是阻塞的吗" aria-hidden="true">#</a> 9. Dubbo服务之间的调用是阻塞的吗？</h2>
<p>默认是同步等待结果阻塞的，支持异步调用。</p>
<p>Dubbo是基于 NIO 的非阻塞实现并行调用，客户端不需要启动多线程即可完成并行调用多个远程服务，相对多线程开销较小，异步调用会返回一个 Future 对象。</p>
<h2 id="_10-dubbomonitor-实现原理" tabindex="-1"><a class="header-anchor" href="#_10-dubbomonitor-实现原理" aria-hidden="true">#</a> 10. DubboMonitor 实现原理？</h2>
...
<h2 id="_11-dubbo有哪些注册中心" tabindex="-1"><a class="header-anchor" href="#_11-dubbo有哪些注册中心" aria-hidden="true">#</a> 11. Dubbo有哪些注册中心？</h2>
<ul>
...
<h2 id="_12-dubbo的集群容错方案有哪些" tabindex="-1"><a class="header-anchor" href="#_12-dubbo的集群容错方案有哪些" aria-hidden="true">#</a> 12. Dubbo的集群容错方案有哪些？</h2>
<ul>
...
<h2 id="_13-dubbo超时设置有哪些方式" tabindex="-1"><a class="header-anchor" href="#_13-dubbo超时设置有哪些方式" aria-hidden="true">#</a> 13. Dubbo超时设置有哪些方式？</h2>
<p>Dubbo超时设置有两种方式：</p>
<ul>
...
<h2 id="_14-dubbo用到哪些设计模式" tabindex="-1"><a class="header-anchor" href="#_14-dubbo用到哪些设计模式" aria-hidden="true">#</a> 14. Dubbo用到哪些设计模式？</h2>
<p>1、<strong>工厂模式</strong></p>
<p>Provider 在 export 服务时，会调用 ServiceConfig 的 export 方法。ServiceConfig中有个字段：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>private static final Protocol protocol =
ExtensionLoader.getExtensionLoader(Protocol.class).getAdaptiveExtensi
on();
复制代码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Dubbo里有很多这种代码。这也是一种工厂模式，只是实现类的获取采用了 JDKSPI 的机制。这么实现的优点是可扩展性强，想要扩展实现，只需要在 classpath下增加个文件就可以了，代码零侵入。另外，像上面的 Adaptive 实现，可以做到调用时动态决定调用哪个实现，但是由于这种实现采用了动态代理，会造成代码调试比较麻烦，需要分析出实际调用的实现类。</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>EchoFilter -&gt; ClassLoaderFilter -&gt; GenericFilter -&gt; ContextFilter -&gt;
ExecuteLimitFilter -&gt; TraceFilter -&gt; TimeoutFilter -&gt; MonitorFilter -&gt;
ExceptionFilter
复制代码
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更确切地说，这里是装饰器和责任链模式的混合使用。例如，EchoFilter 的作用是判断是否是回声测试请求，是的话直接返回内容，这是一种责任链的体现。而像ClassLoaderFilter 则只是在主功能上添加了功能，更改当前线程的 ClassLoader，这是典型的装饰器模式。</p>
