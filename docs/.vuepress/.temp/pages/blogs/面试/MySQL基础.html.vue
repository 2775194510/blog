...
<p><img src="http://blog-img.coolsen.cn/img/image-20210822210317322.png" alt="image-20210822210317322"></p>
<h3 id="_1-数据库的三范式是什么" tabindex="-1"><a class="header-anchor" href="#_1-数据库的三范式是什么" aria-hidden="true">#</a> 1. 数据库的三范式是什么？</h3>
<ul>
...
<h3 id="_2-mysql-支持哪些存储引擎" tabindex="-1"><a class="header-anchor" href="#_2-mysql-支持哪些存储引擎" aria-hidden="true">#</a> 2. MySQL 支持哪些存储引擎?</h3>
...
<h3 id="_3-超键、候选键、主键、外键分别是什么" tabindex="-1"><a class="header-anchor" href="#_3-超键、候选键、主键、外键分别是什么" aria-hidden="true">#</a> 3. 超键、候选键、主键、外键分别是什么？</h3>
<ul>
...
<h3 id="_4-sql-约束有哪几种" tabindex="-1"><a class="header-anchor" href="#_4-sql-约束有哪几种" aria-hidden="true">#</a> 4. SQL 约束有哪几种？</h3>
<ul>
...
<h3 id="_5-mysql-中的-varchar-和-char-有什么区别" tabindex="-1"><a class="header-anchor" href="#_5-mysql-中的-varchar-和-char-有什么区别" aria-hidden="true">#</a> 5. MySQL 中的 varchar 和 char 有什么区别？</h3>
<p>char 是一个定长字段,假如申请了<code v-pre>char(10)</code>的空间,那么无论实际存储多少内容.该字段都占用 10 个字符,而 varchar 是变长的,也就是说申请的只是最大长度,占用的空间为实际字符长度+1,最后一个字符存储使用了多长的空间.</p>
<p>在检索效率上来讲,char &gt; varchar,因此在使用中,如果确定某个字段的值的长度,可以使用 char,否则应该尽量使用 varchar.例如存储用户 MD5 加密后的密码,则应该使用 char。</p>
<h3 id="_6-mysql中-in-和-exists-区别" tabindex="-1"><a class="header-anchor" href="#_6-mysql中-in-和-exists-区别" aria-hidden="true">#</a> 6. MySQL中 in 和 exists 区别</h3>
<p>MySQL中的in语句是把外表和内表作hash 连接，而exists语句是对外表作loop循环，每次loop循环再对内表进行查询。一直大家都认为exists比in语句的效率要高，这种说法其实是不准确的。这个是要区分环境的。</p>
<p>如果查询的两个表大小相当，那么用in和exists差别不大。
如果两个表中一个较小，一个是大表，则子查询表大的用exists，子查询表小的用in。
not in 和not exists：如果查询语句使用了not in，那么内外表都进行全表扫描，没有用到索引；而not extsts的子查询依然能用到表上的索引。所以无论那个表大，用not exists都比not in要快。</p>
<h3 id="_7-drop、delete与truncate的区别" tabindex="-1"><a class="header-anchor" href="#_7-drop、delete与truncate的区别" aria-hidden="true">#</a> 7. drop、delete与truncate的区别</h3>
<p>三者都表示删除，但是三者有一些差别：</p>
<p><img src="http://blog-img.coolsen.cn/img/image-20210822203927822.png" alt="image-20210822203927822"></p>
<h3 id="_8-什么是存储过程-有哪些优缺点" tabindex="-1"><a class="header-anchor" href="#_8-什么是存储过程-有哪些优缺点" aria-hidden="true">#</a> 8. 什么是存储过程？有哪些优缺点？</h3>
...
<h3 id="_9-mysql-执行查询的过程" tabindex="-1"><a class="header-anchor" href="#_9-mysql-执行查询的过程" aria-hidden="true">#</a> 9. MySQL 执行查询的过程</h3>
<ol>
...
<h3 id="_1-什么是数据库事务" tabindex="-1"><a class="header-anchor" href="#_1-什么是数据库事务" aria-hidden="true">#</a> 1. 什么是数据库事务？</h3>
...
<h3 id="_2-介绍一下事务具有的四个特征" tabindex="-1"><a class="header-anchor" href="#_2-介绍一下事务具有的四个特征" aria-hidden="true">#</a> 2. 介绍一下事务具有的四个特征</h3>
...
<h3 id="_3-说一下mysql-的四种隔离级别" tabindex="-1"><a class="header-anchor" href="#_3-说一下mysql-的四种隔离级别" aria-hidden="true">#</a> 3. 说一下MySQL 的四种隔离级别</h3>
<ul>
...
<h3 id="_4-什么是脏读-幻读-不可重复读" tabindex="-1"><a class="header-anchor" href="#_4-什么是脏读-幻读-不可重复读" aria-hidden="true">#</a> 4. 什么是脏读？幻读？不可重复读？</h3>
...
<h3 id="_5-事务的实现原理" tabindex="-1"><a class="header-anchor" href="#_5-事务的实现原理" aria-hidden="true">#</a> 5. 事务的实现原理</h3>
...
<h3 id="_6-mysql事务日志介绍下" tabindex="-1"><a class="header-anchor" href="#_6-mysql事务日志介绍下" aria-hidden="true">#</a> 6. MySQL事务日志介绍下？</h3>
...
<h4 id="redo-log" tabindex="-1"><a class="header-anchor" href="#redo-log" aria-hidden="true">#</a> redo log</h4>
...
<h4 id="undo-log" tabindex="-1"><a class="header-anchor" href="#undo-log" aria-hidden="true">#</a> undo log</h4>
...
<h3 id="_7-什么是mysql的-binlog" tabindex="-1"><a class="header-anchor" href="#_7-什么是mysql的-binlog" aria-hidden="true">#</a> 7. 什么是MySQL的 binlog？</h3>
...
<ul>
<li>
<p><strong>statement：</strong> 基于 SQL 语句的模式，某些语句和函数如 UUID, LOAD DATA INFILE 等在复制过程可能导致数据不一致甚至出错。</p>
</li>
<li>
<p><strong>row：</strong> 基于行的模式，记录的是行的变化，很安全。但是 binlog 会比其他两种模式大很多，在一些大表中清除大量数据时在 binlog 中会生成很多条语句，可能导致从库延迟变大。</p>
</li>
<li>
<p><strong>mixed：</strong> 混合模式，根据语句来选用是 statement 还是 row 模式。</p>
</li>
</ul>
<h3 id="_8-在事务中可以混合使用存储引擎吗" tabindex="-1"><a class="header-anchor" href="#_8-在事务中可以混合使用存储引擎吗" aria-hidden="true">#</a> <strong>8. 在事务中可以混合使用存储引擎吗？</strong></h3>
...
<h3 id="_9-mysql中是如何实现事务隔离的" tabindex="-1"><a class="header-anchor" href="#_9-mysql中是如何实现事务隔离的" aria-hidden="true">#</a> 9. MySQL中是如何实现事务隔离的?</h3>
...
<h3 id="_10-什么是-mvcc" tabindex="-1"><a class="header-anchor" href="#_10-什么是-mvcc" aria-hidden="true">#</a> 10. 什么是 MVCC？</h3>
<p>MVCC， 即多版本并发控制。MVCC 的实现，是通过保存数据在某个时间点的快照来实现的。根据事务开始的时间不同，每个事务对同一张表，同一时刻看到的数据可能是不一样的。</p>
<h3 id="_11-mvcc-的实现原理" tabindex="-1"><a class="header-anchor" href="#_11-mvcc-的实现原理" aria-hidden="true">#</a> 11. MVCC 的实现原理</h3>
...
<h3 id="_1-为什么要加锁" tabindex="-1"><a class="header-anchor" href="#_1-为什么要加锁" aria-hidden="true">#</a> 1. 为什么要加锁?</h3>
<p>当多个用户并发地存取数据时，在<a href="https://cloud.tencent.com/solution/database?from=10680" target="_blank" rel="noopener noreferrer">数据库</a>中就会产生多个事务同时存取同一数据的情况。若对并发操作不加控制就可能会读取和存储不正确的数据，破坏数据库的一致性。</p>
<p>保证多用户环境下保证数据库完整性和一致性。</p>
<h3 id="_2-按照锁的粒度分数据库锁有哪些" tabindex="-1"><a class="header-anchor" href="#_2-按照锁的粒度分数据库锁有哪些" aria-hidden="true">#</a> 2. 按照锁的粒度分数据库锁有哪些？</h3>
<p>在关系型数据库中，可以<strong>按照锁的粒度把数据库锁分</strong>为行级锁(INNODB引擎)、表级锁(MYISAM引擎)和页级锁(BDB引擎 )。</p>
<p>行级锁</p>
<ul>
<li>行级锁是<a href="https://cloud.tencent.com/product/cdb?from=10680" target="_blank" rel="noopener noreferrer">MySQL</a>中锁定粒度最细的一种锁，表示只针对当前操作的行进行加锁。行级锁能大大减少数据库操作的冲突。其加锁粒度最小，但加锁的开销也最大。行级锁分为共享锁 和 排他锁。</li>
...
<h3 id="_3-从锁的类别上分mysql都有哪些锁呢" tabindex="-1"><a class="header-anchor" href="#_3-从锁的类别上分mysql都有哪些锁呢" aria-hidden="true">#</a> 3. 从锁的类别上分MySQL都有哪些锁呢？</h3>
...
<h3 id="_4-数据库的乐观锁和悲观锁是什么-怎么实现的" tabindex="-1"><a class="header-anchor" href="#_4-数据库的乐观锁和悲观锁是什么-怎么实现的" aria-hidden="true">#</a> 4. 数据库的乐观锁和悲观锁是什么？怎么实现的？</h3>
...
<h3 id="_5-innodb引擎的行锁是怎么实现的" tabindex="-1"><a class="header-anchor" href="#_5-innodb引擎的行锁是怎么实现的" aria-hidden="true">#</a> 5. InnoDB引擎的行锁是怎么实现的？</h3>
...
<h3 id="_6-什么是死锁-怎么解决" tabindex="-1"><a class="header-anchor" href="#_6-什么是死锁-怎么解决" aria-hidden="true">#</a> 6. 什么是死锁？怎么解决？</h3>
...
<h3 id="_7-隔离级别与锁的关系" tabindex="-1"><a class="header-anchor" href="#_7-隔离级别与锁的关系" aria-hidden="true">#</a> 7. 隔离级别与锁的关系</h3>
...
<h3 id="_8-优化锁方面的意见" tabindex="-1"><a class="header-anchor" href="#_8-优化锁方面的意见" aria-hidden="true">#</a> 8. 优化锁方面的意见？</h3>
<ul>
<li>使用较低的隔离级别</li>
...
<h3 id="_1-为什么要分库分表" tabindex="-1"><a class="header-anchor" href="#_1-为什么要分库分表" aria-hidden="true">#</a> 1. 为什么要分库分表？</h3>
...
<p>这就是所谓的分库分表。</p>
<p><img src="https://upload-images.jianshu.io/upload_images/14266602-ae74054f45f44e3d?imageMogr2/auto-orient/strip|imageView2/2/w/1240" alt="img"></p>
...
<h5 id="cobar" tabindex="-1"><a class="header-anchor" href="#cobar" aria-hidden="true">#</a> cobar</h5>
<p>阿里 b2b 团队开发和开源的，属于 proxy 层方案。早些年还可以用，但是最近几年都没更新了，基本没啥人用，差不多算是被抛弃的状态吧。而且不支持读写分离、存储过程、跨库 join 和分页等操作。</p>
<h5 id="tddl" tabindex="-1"><a class="header-anchor" href="#tddl" aria-hidden="true">#</a> TDDL</h5>
<p>淘宝团队开发的，属于 client 层方案。支持基本的 crud 语法和读写分离，但不支持 join、多表查询等语法。目前使用的也不多，因为还依赖淘宝的 diamond 配置管理系统。</p>
<h5 id="atlas" tabindex="-1"><a class="header-anchor" href="#atlas" aria-hidden="true">#</a> atlas</h5>
<p>360 开源的，属于 proxy 层方案，以前是有一些公司在用的，但是确实有一个很大的问题就是社区最新的维护都在 5 年前了。所以，现在用的公司基本也很少了。</p>
<h5 id="sharding-jdbc" tabindex="-1"><a class="header-anchor" href="#sharding-jdbc" aria-hidden="true">#</a> sharding-jdbc</h5>
...
<h5 id="mycat" tabindex="-1"><a class="header-anchor" href="#mycat" aria-hidden="true">#</a> mycat</h5>
...
<h3 id="_3-如何对数据库如何进行垂直拆分或水平拆分的" tabindex="-1"><a class="header-anchor" href="#_3-如何对数据库如何进行垂直拆分或水平拆分的" aria-hidden="true">#</a> 3. 如何对数据库如何进行垂直拆分或水平拆分的？</h3>
...
<p><img src="https:////upload-images.jianshu.io/upload_images/10089464-0e01dfe246b5c7ac.png?imageMogr2/auto-orient/strip|imageView2/2/w/474/format/webp" alt="img"></p>
...
<p><img src="https:////upload-images.jianshu.io/upload_images/10089464-ab3069913c0f097c.png?imageMogr2/auto-orient/strip|imageView2/2/w/320/format/webp" alt="img"></p>
...
<h2 id="读写分离、主从同步-复制" tabindex="-1"><a class="header-anchor" href="#读写分离、主从同步-复制" aria-hidden="true">#</a> 读写分离、主从同步（复制）</h2>
<h3 id="_1-什么是mysql主从同步" tabindex="-1"><a class="header-anchor" href="#_1-什么是mysql主从同步" aria-hidden="true">#</a> 1. 什么是MySQL主从同步？</h3>
...
<h3 id="_2-mysql主从同步的目的-为什么要做主从同步" tabindex="-1"><a class="header-anchor" href="#_2-mysql主从同步的目的-为什么要做主从同步" aria-hidden="true">#</a> 2. MySQL主从同步的目的？为什么要做主从同步？</h3>
<ol>
...
<h3 id="_3-如何实现mysql的读写分离" tabindex="-1"><a class="header-anchor" href="#_3-如何实现mysql的读写分离" aria-hidden="true">#</a> 3. 如何实现MySQL的读写分离？</h3>
<p>其实很简单，就是基于主从复制架构，简单来说，就搞一个主库，挂多个从库，然后我们就单单只是写主库，然后主库会自动把数据给同步到从库上去。</p>
<h3 id="_4-mysql主从复制流程和原理" tabindex="-1"><a class="header-anchor" href="#_4-mysql主从复制流程和原理" aria-hidden="true">#</a> 4. MySQL主从复制流程和原理？</h3>
<p>基本原理流程，是3个线程以及之间的关联</p>
...
<h3 id="_5-mysql主从同步延时问题如何解决" tabindex="-1"><a class="header-anchor" href="#_5-mysql主从同步延时问题如何解决" aria-hidden="true">#</a> 5. MySQL主从同步延时问题如何解决？</h3>
...
<h2 id="mysql优化" tabindex="-1"><a class="header-anchor" href="#mysql优化" aria-hidden="true">#</a> MySQL优化</h2>
<h3 id="_1-如何定位及优化sql语句的性能问题" tabindex="-1"><a class="header-anchor" href="#_1-如何定位及优化sql语句的性能问题" aria-hidden="true">#</a> 1. 如何定位及优化SQL语句的性能问题？</h3>
...
<p>而执行计划，就是显示数据库引擎对于SQL语句的执行的详细情况，其中包含了是否使用索引，使用什么索引，使用的索引的相关信息等。
<img src="http://blog-img.coolsen.cn/img/image-20210822204026552.png" alt="image-20210822204026552"></p>
<h3 id="_2-大表数据查询-怎么优化" tabindex="-1"><a class="header-anchor" href="#_2-大表数据查询-怎么优化" aria-hidden="true">#</a> 2. 大表数据查询，怎么优化</h3>
<ul>
...
<h3 id="_3-超大分页怎么处理" tabindex="-1"><a class="header-anchor" href="#_3-超大分页怎么处理" aria-hidden="true">#</a> 3. 超大分页怎么处理?</h3>
<p>数据库层面,这也是我们主要集中关注的(虽然收效没那么大),类似于<code v-pre>select * from table where age &gt; 20 limit 1000000</code>,10 这种查询其实也是有可以优化的余地的. 这条语句需要 load1000000 数据然后基本上全部丢弃,只取 10 条当然比较慢. 当时我们可以修改为<code v-pre>select * from table where id in (select id from table where age &gt; 20 limit 1000000,10)</code>.这样虽然也 load 了一百万的数据,但是由于索引覆盖,要查询的所有字段都在索引中,所以速度会很快。</p>
...
<h3 id="_4-统计过慢查询吗-对慢查询都怎么优化过" tabindex="-1"><a class="header-anchor" href="#_4-统计过慢查询吗-对慢查询都怎么优化过" aria-hidden="true">#</a> 4. 统计过慢查询吗？对慢查询都怎么优化过？</h3>
...
<h3 id="_5-如何优化查询过程中的数据访问" tabindex="-1"><a class="header-anchor" href="#_5-如何优化查询过程中的数据访问" aria-hidden="true">#</a> 5. 如何优化查询过程中的数据访问</h3>
<ul>
...
使用索引覆盖扫描，把所有的列都放到索引中，这样存储引擎不需要回表获取对应行就可以返回结果。</li>
<li>改变数据库和表的结构，修改数据表范式</li>
<li>重写SQL语句，让优化器可以以更优的方式执行查询。</li>
</ul>
<h3 id="_6-如何优化关联查询" tabindex="-1"><a class="header-anchor" href="#_6-如何优化关联查询" aria-hidden="true">#</a> 6. 如何优化关联查询</h3>
<ul>
<li>确定ON或者USING子句中是否有索引。</li>
<li>确保GROUP BY和ORDER BY只有一个表中的列，这样MySQL才有可能使用索引。</li>
</ul>
<h3 id="_7-数据库结构优化" tabindex="-1"><a class="header-anchor" href="#_7-数据库结构优化" aria-hidden="true">#</a> 7. 数据库结构优化</h3>
...
<h3 id="_8-mysql数据库cpu飙升到500-的话他怎么处理" tabindex="-1"><a class="header-anchor" href="#_8-mysql数据库cpu飙升到500-的话他怎么处理" aria-hidden="true">#</a> 8. MySQL数据库cpu飙升到500%的话他怎么处理？</h3>
...
<h3 id="_9-大表怎么优化" tabindex="-1"><a class="header-anchor" href="#_9-大表怎么优化" aria-hidden="true">#</a> 9. 大表怎么优化？</h3>
...
<p>https://haicoder.net/note/mysql-interview/mysql-interview-mysql-binlog.html</p>
<p>https://www.modb.pro/db/40241</p>
<p>https://www.jianshu.com/p/05da0fc0950e</p>
<p>https://blog.csdn.net/ThinkWon/article/details/104778621</p>
</div></template>
