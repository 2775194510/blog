...
### 1-6：Oracle JDK 和 OpenJDK 的区别是什么？
...
### 2-3：**访问修饰符public、private、protected、以及不写（默认）时的区别**？
...
### 2-4：break ,continue ,return 的区别及作用？
...
### 3-3：”static”关键字是什么意思？Java中是否可以覆盖(override)一个private或者是static的方法？

“static”关键字表明一个成员变量或者是成员方法可以在没有所属的类的实例变量的情况下被访问。

Java中static方法不能被覆盖，因为方法覆盖是基于运行时动态绑定的，而static方法是编译时静态绑定的。static方法跟类的任何实例都不相关，所以概念上不适用。

### 3-4：是否可以在static环境中访问非static变量？

static变量在Java中是属于类的，它在所有的实例中的值是一样的。当类被Java虚拟机载入的时候，会对static变量进行初始化。如果你的代码尝试不用实例来访问非static的变量，编译器会报错，因为这些变量还没有被创建出来，还没有跟任何实例关联上。

### 3-5：static静态方法能不能引用非静态资源？

不能，new的时候才会产生的东西，对于初始化后就存在的静态资源来说，根本不认识它。

### 3-6：static静态方法里面能不能引用静态资源？

可以，因为都是类初始化的时候加载的，大家相互都认识。

### 3-7：非静态方法里面能不能引用静态资源？

可以，非静态方法就是实例方法，那是new之后才产生的，那么属于类的内容它都认识。

### 3-8：java静态变量、代码块、和静态方法的执行顺序是什么？
...
### 4-4：重载（Overload）和重写（Override）的区别是什么？
...
### 4-6：构造器（constructor）是否可被重写（override）？
...
### 4-12：值传递和引用传递的区别的什么？为什么说Java中只有值传递？
...
### 5-5：String,StringBuffer, StringBuilder 的区别是什么？
...
[http://c.biancheng.net/view/769.html](http://c.biancheng.net/view/769.html)

[http://www.51gjie.com/java/81.html](http://www.51gjie.com/java/81.html)

[http://www.justdojava.com/2019/03/21/Java-and-equals/](http://www.justdojava.com/2019/03/21/Java-and-equals/)

[https://blog.csdn.net/qq_28051453/article/details/52701171](https://blog.csdn.net/qq_28051453/article/details/52701171)

[https://www.cnblogs.com/wkfvawl/p/11693260.html](https://www.cnblogs.com/wkfvawl/p/11693260.html)