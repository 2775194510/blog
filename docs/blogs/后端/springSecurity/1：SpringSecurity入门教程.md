...
**ExceptionTranslationFilter：** 处理 **过滤器链** 中抛出的任何`AccessDeniedException`和`AuthenticationException` 。
...
public class JwtUtil {
    ...
    //设置秘钥明文
    public static final String JWT_KEY = "xiaoze";
...
import com.xiaoze.domain.LoginUser;
import com.xiaoze.domain.User;
import com.xiaoze.mapper.UserMapper;
...
<mapper namespace="com.xiaoze.mapper.MenuMapper">
